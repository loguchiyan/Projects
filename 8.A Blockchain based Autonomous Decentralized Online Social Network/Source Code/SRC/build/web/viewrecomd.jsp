    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="margin-top: 200px;">
            ...
            <h3 class="h4" align="center" style=" color: white; font-size: 20px; margin-top:-130px; text-align:center; ">Recommended By Group based On Block </h3>
		 <center><table>					
            <tr>                                               
            <th>Group</th>
           <th>Details</th>
                        ...
                        while(rs.next()){
                         ...
                         %>
                          ...
                          <tr>
                           ...
                           <td><a style=" background-color: skyblue; color:  black;" href="viewfullrcmd.jsp?grup=<%=rs.getString("grup")%>&&hash=<%=rs.getString("hash")%>">View Details</a></td>
                      <%}%>
            </tr></table></center>
