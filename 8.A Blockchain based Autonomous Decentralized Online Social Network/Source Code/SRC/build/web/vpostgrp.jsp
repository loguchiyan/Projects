    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="margin-top: 200px;">
            ...
            <h3 class="h4" align="center" style=" color: white; font-size: 20px; margin-top: -100px; text-algin:center;">Post Based on Block</h3>
                        ...
                        while(rs.next()){
                         ...
                         %>
                          ...
                          <tr>
                           ...
                           <td><a style=" background-color: skyblue; color:  black;" href="viewupstfull.jsp?grup=<%=rs.getString("grup")%>&&hash=<%=rs.getString("hash")%>">View Details</a></td>
                      <%}%>
            </tr></table>
