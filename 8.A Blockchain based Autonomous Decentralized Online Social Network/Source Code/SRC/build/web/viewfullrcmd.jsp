          ...
          <div class="row " style="margin-top: 200px;">
             ...
             <style>
                    ...
                    th{
                         ...
                         %>
                                                    <h3 class="h4" align="center" style=" color: white; font-size: 20px; margin-bottom: 400px;  margin-top: -100px; text-align:center; "> Post  Based On <%=grup%> Block<br><br> Block Hash: <span style="color:green; "><%=hash%></span> </h3>
			<center>	
                         <table>					
            <tr>                                               
            <th>User Name</th>
           ...
           <th>Location</th>
            ...
            <a href="viewrecomd.jsp">Click Back</a>
          </main>
