  ...
  <section id="container">
    ...
    <section id="main-content" style=" background-color: #2f323a;">
     ...
     <main >
                   ...
                   <h1 style=" color: whitesmoke; font-size:30px; font-family:  monospace; align:centre; font-weight:Bolder; margin-left: 285px; margin-top: 10px; ">Prediction in Graph.... <h1>
