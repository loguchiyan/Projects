...
System.out.println("Hashkey:"+sb.toString());
                    ...
                    PreparedStatement ps1=con.prepareStatement("Update ureg set hash='"+sb.toString()+"' where grup='"+grup+"' ");
                    System.out.println(ps1);
                    ps1.executeUpdate();
                    System.out.println(ps1);
                    PreparedStatement query=con.prepareStatement("Update post set hash='"+sb.toString()+"' where grup='"+grup+"' ");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                      PreparedStatement ps=con.prepareStatement("Update recommed set hash='"+sb.toString()+"' where grup='"+grup+"' ");
                   ps.executeUpdate();
                   System.out.println(ps);
                    ...
                    RequestDispatcher rd=request.getRequestDispatcher("hash.jsp");
