...
insert  into `account`(`sno`,`uuser`,`ctype`,`bname`,`acc`,`ifsc`,`cvv`,`branch`,`money`,`date`) values (6,'AbiShankar','Credit Card','IOB','9674569780','Sbi099','234','chennai','50000','2023-01-04 12:45:45'),(7,'AbiShankar','Credit Card','IOB','9674569780','IOB0001','235','Vadapalani','50000','2023-02-03 10:06:43'),(8,'AbiShankar','null','null','null','null','null','null','50000','2023-02-03 10:06:44');
...
insert  into `oreg`(`sno`,`ouser`,`pass`,`email`,`dob`,`contact`,`loc`,`status`) values (2,'Lakshmi','lakshmi','lakshmi@gmail.com','14/09/88','8678667567','Chennai','Activated'),(3,'Gokul','1234','otpsendermessage@gmail.com','12/12/1999','98675644564','Madurai ','Activated');
...
CREATE TABLE `review` (
  `ouser` varchar(200) DEFAULT NULL,
...
insert  into `review`(`ouser`,`pname`,`pcat`,`image`,`review`,`ranking`) values ('AbiShankar','Realme','Mobile Products','cyper.jpg','good','* * * * *'),('AbiShankar','Realme','Mobile Products','cyper.jpg','good','* * * * *');
...
CREATE TABLE `upload` (
  ...
  `pband` varchar(200) DEFAULT NULL,
...
insert  into `upload`(`sno`,`ouser`,`pid`,`pcat`,`pband`,`pname`,`cost`,`des`,`loc`,`image`,`hashkey`,`date`) values (21,'Gokul','PID9662','Mobile Products','Realme','Realme','15000','Branded Mobile','Anna Nagar Chennai','hh.jpeg','d71faf6446614294aec6e81a3c7d6f61','2023-01-27 14:24:21'),(22,'Gokul','PID2691','Mobile Products','Samsung','Galaxy Z','15000','good','velacheery','cyper.png','d71faf6446614294aec6e81a3c7d6f61','2023-01-27 14:32:56'),(23,'Gokul','PID1611','Mobile Products','Lenovo','LENOVO9','15000','Branded Mobile','Melur Madurai','reg.png','7baecd4bd3b1448d5c33fd1e9e2ce546','2023-02-03 10:05:43');
...
insert  into `ureg`(`sno`,`uuser`,`pass`,`email`,`dob`,`contact`,`loc`,`status`) values (1,'Deepa','deepa','deepa@gmail.com','14/09/88','8678667567','Chennai','Activated'),(2,'AbiShankar','1234','otpsendermessage@gmail.com','12/12/199','98675644564','Madurai ','Activated');
...
insert  into `ureq`(`sno`,`uuser`,`ouser`,`pid`,`pname`,`cost`,`des`,`hashkey`,`status`,`status1`,`purchased`,`date`) values (460,'AbiShankar','Gokul','PID4617','Realme','15000','Branded Mobile','d71faf6446614294aec6e81a3c7d6f61','Waiting','Not Purchased','0','2023-01-19 12:48:38'),(461,'AbiShankar','Gokul','PID4617','Realme','15000','Branded Mobile','d71faf6446614294aec6e81a3c7d6f61','Waiting','Not Purchased','0','2023-01-19 12:48:38'),(462,'AbiShankar','Gokul','PID1611','LENOVO9','15000','Branded Mobile','d71faf6446614294aec6e81a3c7d6f61','Waiting','Not Purchased','0','2023-02-03 10:07:23'),(463,'AbiShankar','Gokul','PID1611','LENOVO9','15000','Branded Mobile','d71faf6446614294aec6e81a3c7d6f61','Accpted','Product Purchased','1','2023-02-03 10:07:23');
