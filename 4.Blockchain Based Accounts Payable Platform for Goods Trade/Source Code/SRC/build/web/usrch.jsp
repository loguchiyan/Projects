        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="" id="">
            ...
            <div class="User_option">
                ...
                <a href="usrch.jsp" style=" color: #ffc107;">My View Search History</a>&ensp;&ensp;
...
h6{
    font-size:13px;
     ...
     <%    
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload where pid='"+pid+"'and pname='"+pname+"' ");
