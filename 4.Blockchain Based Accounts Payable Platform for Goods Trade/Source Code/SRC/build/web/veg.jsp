  ...
  <div class="hero_area ">
   ...
   <style>
    ...
    <section class="slider_section">
        ...
        <br>
      <div class="container">
          <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View Products based on Mobile Product Blocks</h1>
         <style>
             .gallery {
	display: flex;
	flex-wrap: wrap;
...
h6{
    font-size:13px;
          ...
          <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload where ouser='"+ouser+"' and pcat='Mobile Products' ");
		...
		<div class="gallery-item" >
                    <center>
			<img class="gallery-image" src="profile/<%=rs.getString("image") %>" alt="image" style=" height:100px; width:150px; border: 2px solid  #ffc107; ">
		      <p ><%=rs.getString("pname")%></p>
                      <h6>Hashkey</h6>
                      <p><%=rs.getString("hashkey")%></p>
                      <a style=" color: white;" href="hash.jsp?pid=<%=rs.getString("pid")%>">Update Original Hashkey</a>
                      </center>
                </div>
                        ...
                        <a href="view1.jsp" style=" text-align:center; color:white;">Click Back to Blocks</a>
    </section>
    <!-- end slider section -->
  </div>
