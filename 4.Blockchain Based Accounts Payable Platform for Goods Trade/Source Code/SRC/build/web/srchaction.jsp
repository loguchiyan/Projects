...
h6{
    font-size:13px;
     ...
     <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View details and Make Hashkey Request</h1>
     ...
     <%    
        ...
        <tr>
            ...
            <td><%= pid%></td>
                    ...
                    <td><%=loc%></td>
                    <td><a  style=" color:darkblue;"href="review.jsp?image=<%=rs.getString("image")%>&&ouser=<%=rs.getString("ouser")%>&&pname=<%=rs.getString("pname")%>&&pcat=<%=rs.getString("pcat")%>"> <b>Make Review and Ranking</b></a></td>
                      <td><a href="req1.jsp?uuser=<%=uuser%>&&ouser=<%=ouser%>&&pid=<%=pid%>&&pname=<%=pname%>&&cost=<%=cost%>&&des=<%=des%>" style=" color: darkblue; font-weight:bolder;">Make Request</a></td>
            <%}%></table> <br>
                        <br>
