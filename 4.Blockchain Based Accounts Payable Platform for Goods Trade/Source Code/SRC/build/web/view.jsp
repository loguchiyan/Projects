  ...
  <div class="hero_area ">
   ...
   <style>
    ...
    <section class="slider_section">
        ...
        <br>
      <div class="container">
          <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View Products</h1>
         <style>
             .gallery {
	display: flex;
	flex-wrap: wrap;
...
.gallery-item {
	...
	overflow: hidden;
		...
		<div class="gallery-item">
			<img class="gallery-image" src="profile/<%=rs.getString("image") %>" alt="image" style=" height:200px; width: 250px; border: 2px solid  #ffc107; ">
