  ...
  <div class="hero_area ">
   ...
   <style>
    ...
    <section class="slider_section">
        ...
        <br>
      <div class="container">
          <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View Products based on Other Product Blocks</h1>
         <style>
             .gallery {
	display: flex;
	flex-wrap: wrap;
...
h6{
    font-size:13px;
          ...
          <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload where ouser='"+ouser+"' and pcat='Other Products' ");
