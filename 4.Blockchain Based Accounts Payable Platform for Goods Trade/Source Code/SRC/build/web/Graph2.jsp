...
PreparedStatement p=con.prepareStatement("select ranking,count(*)total from review group by ranking ");
ResultSet r=p.executeQuery();
List<Map<Object,Object>> list = new ArrayList<Map<Object,Object>>();
while(r.next()){
     String filename=r.getString("ranking");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	exportEnabled: true,
	title: {
		text: "Graph based Top K-Results"
	},
	axisY:{
		includeZero: true
	},
