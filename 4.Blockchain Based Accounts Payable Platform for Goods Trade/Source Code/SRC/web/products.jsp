    ...
    font-size:13px;
     ...
     <%    
      ...
      String pid=request.getParameter("pid");
                        ...
                        PreparedStatement query=con.prepareStatement("select DISTINCT sno,pid,pname,ouser,uuser,cost,des,status,status1,hashkey from ureq where uuser='"+uuser+"' and status='Accpted'  ");
        ...
        <tr>
                    ...
                    <td style=" color: darkviolet"><a href="buy.jsp?sno=<%=sno%>"><%=status1%></a></td>
