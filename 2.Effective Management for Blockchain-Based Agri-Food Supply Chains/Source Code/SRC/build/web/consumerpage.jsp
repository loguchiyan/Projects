    ...
    <div id="content">
        ...
        <div class="projects">
          <div align="center">
            <form id="form1" name="form1" method="post" action="FarmerLogin">
              <p class="style21"><a href="farmerregister.jsp" class="style22">Consumer Page </a></p>
              <p class="style21"><img src="images/consumer.jpg" width="620" height="464" /></p>
            </form>
          </div>
        </div>
      </div>
      <div class="gallery-info">
        <div class="box-head">
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <p class="style1"><span class="style5"><span class="style6"><span class="style1"><span class="style8"><span class="style10"><span class="style1"><a href="consumerbuy.jsp">Buy Product </a></span></span></span></span></span></span></p>
          <p class="style12">&nbsp;</p>
