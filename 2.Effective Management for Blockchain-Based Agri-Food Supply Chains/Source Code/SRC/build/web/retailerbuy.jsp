...
<div id="shell">
  ...
  <div id="navigation">
    <ul>
       ...
       <li><a href="retailerbuy.jsp">BuyCrop</a></li>
      <li><a href="retailerstatus.jsp">ViewStatus</a></li>
      <li><a href="retailerlogin.jsp">Logout</a></li>
    ...
    <div id="content">
      ...
      <div class="gallery">
          ...
          <div align="center">
            <table width="604" height="250" border="0" >
              ...
              <tr>
                ...
                <td width="152"><div align="center"><span class="style21">Distributor </span></div></td>
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodnetworkblockchain","root","password");
                                            ...
                                            String query = "select * from cropdetails where retailer='"+status+"' && distributor!='"+status+"'"; 
                                            ...
                                            while (rs.next()) {
											 ...
											 double percent = (double)((double)price + (double)((double)((double)price*(double)30)/(double)100));
                                           
                                    %>
              <tr>
			    <form id="form1" name="form1" method="post" action="RetailerProcess">
                <td><div align="center">
      ...
      <div class="gallery-info">
        <div class="box-head">
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="retailerbuy.jsp">Buy Product </a></span></span></span></span></p>
          <p class="style12">&nbsp;</p>
          <p><span class="style12"><a href="retailerstatus.jsp">View status </a></span></p>
          <p>&nbsp;</p>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="retailerlogin.jsp">Logout</a></span></span></span></span></p>
          <p>&nbsp;</p>
          <p>&nbsp; </p>
        </div>
      </div>
