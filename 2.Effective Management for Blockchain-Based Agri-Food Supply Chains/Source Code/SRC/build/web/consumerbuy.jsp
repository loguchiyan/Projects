...
<div id="shell">
  ...
  <div id="navigation">
    <ul>
       ...
       <li><a href="consumerbuy.jsp">BuyProduct</a></li>
      <li><a href="consumerstatus.jsp">ViewStatus</a></li>
      <li><a href="consumerlogin.jsp">Logout</a></li>
    ...
    <div id="content">
      ...
      <div class="gallery">
        <div class="projects">
          <div align="center">
            <table width="604" height="250" border="0" >
              <tr>
                <td height="67" colspan="7" bgcolor="#3C9BEB"><div align="center"><span class="style23">BUY PRODUCT </span></div></td>
              </tr>
              <tr>
                <td width="91"><div align="center"><span class="style21">Options</span></div></td>
                <td width="152"><div align="center"><span class="style21">Retailer </span></div></td>
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodnetworkblockchain","root","password");
                                            ...
                                            String query = "select * from cropdetails where consumer='"+status+"' && retailer!='"+status+"'"; 
                                            st = con.createStatement();
                                            rs = st.executeQuery(query);

                                            while (rs.next()) {
                                                String id = rs.getString(7);
                                                String s1 = rs.getString(10);
                                                String s2 = rs.getString(2);
												
												String s3 = rs.getString(3);
                                               String s4 = rs.getString(4);
											 int price=Integer.parseInt(s4);
											 double percent = (double)((double)price + (double)((double)((double)price*(double)40)/(double)100));
                                           
                                    %>
              <tr>
			    <form id="form1" name="form1" method="post" action="ConsumerProcess">
                <td><div align="center">
      ...
      <div class="gallery-info">
        <div class="box-head">
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="consumerbuy.jsp">Buy Product </a></span></span></span></span></p>
          <p class="style12">&nbsp;</p>
          <p><span class="style12"><a href="consumerstatus.jsp">View status </a></span></p>
          <p>&nbsp;</p>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="consumerlogin.jsp">Logout</a></span></span></span></span></p>
          <p>&nbsp;</p>
          <p>&nbsp; </p>
        </div>
      </div>
