      ...
      <div class="gallery">
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodnetworkblockchain","root","password");
                                            ...
                                            String query = "select * from cropdetails where consumer='"+username+"'"; 
              ...
              <tr>
                ...
                <td><div align="center" class="style21">Retailer</div></td>
              ...
              <tr>
                ...
                <td width="126"><div align="center">
                    <label></label>
                    <%=s2%></div></td>
                <td width="119"><div align="center"><%=percent%></div></td>
