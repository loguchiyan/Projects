...
<div id="shell">
  ...
  <div id="navigation">
    <ul>
     ...
     <li><a href="distributorbuy.jsp">BuyCrop</a></li>
      <li><a href="distributorstatus.jsp">ViewStatus</a></li>
      <li><a href="distributorlogin.jsp">Logout</a></li>
    ...
    <div id="content">
      ...
      <div class="gallery">
        <div class="projects">
          <div align="center">
            <table width="604" height="250" border="0" >
              <tr>
                <td height="67" colspan="8" bgcolor="#3C9BEB"><div align="center"><span class="style23">BUY PRODUCT </span></div></td>
              </tr>
              <tr>
                <td width="91"><div align="center"><span class="style21">Options</span></div></td>
                <td width="152"><div align="center"><span class="style21">Processor </span></div></td>
                <td width="157"><div align="center"><span class="style21">Product</span></div></td>
                <td width="157"><div align="center"><span class="style21">Quantity</span></div></td>
                <td width="120"><div align="center"><span class="style21">Price</span></div></td>
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodnetworkblockchain","root","password");
                                            ...
                                            String query = "select * from cropdetails where distributor='"+status+"' && processor!='"+status+"'"; 
                                            ...
                                            while (rs.next()) {
											 ...
											 double percent = (double)((double)price + (double)((double)((double)price*(double)15)/(double)100));
                                           
                                    %>
              <tr>
			    <form id="form1" name="form1" method="post" action="DistributorProcess">
                <td><div align="center">
                ...
                <td><div align="center">
                    <label></label>
                    <%=percent%></div></td>
                <td width="62"><input type="submit" name="Submit" value="BUY" /></td>
				</form>
              </tr>
              <p>
                <%
      ...
      <div class="gallery-info">
        <div class="box-head">
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="distributorbuy.jsp">Buy Product </a></span></span></span></span></p>
          <p class="style12">&nbsp;</p>
          <p><span class="style12"><a href="distributorstatus.jsp">View status </a></span></p>
          <p>&nbsp;</p>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="distributorlogin.jsp">Logout</a></span></span></span></span></p>
          <p>&nbsp;</p>
          <p>&nbsp; </p>
        </div>
      </div>
