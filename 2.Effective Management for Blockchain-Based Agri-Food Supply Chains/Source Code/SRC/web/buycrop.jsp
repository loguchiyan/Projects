      ...
      <div class="gallery">
          ...
          <div align="center">
            <table width="604" height="250" border="0" >
              ...
              <tr>
                ...
                <td width="152"><div align="center"><span class="style21">Farmer name </span></div></td>
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodnetworkblockchain","root","password");
                                            ...
                                            String query = "select * from cropdetails where processor='"+status+"'"; 
                                    ...
                                    %>
              <tr>
			    <form id="form1" name="form1" method="post" action="ProcessorProcess">
                <td><div align="center">
