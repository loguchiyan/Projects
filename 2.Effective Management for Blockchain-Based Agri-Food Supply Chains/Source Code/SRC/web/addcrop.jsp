...
<div id="shell">
  ...
  <div id="navigation">
    <ul>
      ...
      <li><a href="viewstatus.jsp">ViewStatus</a></li>
      <li><a href="farmerlogin.jsp">Logout</a></li>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="gallery">
        <div class="projects">
          <div align="center">
            <form id="form1" name="form1" method="post" action="AddCrop">
              <table width="417" height="334" border="0">
                <tr>
                  <td colspan="2" bgcolor="#4197C9" class="style21"><div align="center" class="style20">Add Crop </div></td>
                </tr>
                <tr>
                  <td width="164" class="style21">Crop Name :</td>
                  <td width="215"><span><span>
                    <input type="text" id="cropname" name="cropname" class="login_input" />
                  </span></span></td>
                </tr>
                <tr>
                  <td class="style21">Quantity :</td>
                  <td><span><span>
                    <input name="quantity" type="text" class="login_input" id="quantity" />
                  </span></span></td>
                </tr>
                <tr>
                  <td class="style21">Price :</td>
                  <td><input type="text" id="price" name="price" class="login_input" /></td>
                </tr>
      ...
      <div class="gallery-info">
        <div class="box-head">
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <p class="style1"><span class="style5"><span class="style6"><span class="style1"><span class="style8"><span class="style10"><span class="style1"><a href="addcrop.jsp">Add Crop </a></span></span></span></span></span></span></p>
          <p class="style12">&nbsp;</p>
          <p><span class="style12"><a href="viewstatus.jsp">View status </a></span></p>
          <p>&nbsp;</p>
          <p class="style1"><span class="style5"><span class="style6"><span class="style8"><span class="style10"><a href="farmerlogin.jsp">Logout</a></span></span></span></span></p>
          <p>&nbsp;</p>
          <p>&nbsp; </p>
        </div>
      </div>
