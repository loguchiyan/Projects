...
public class personal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{   
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/studentadmission","root","root");    
                    PreparedStatement query=con.prepareStatement("insert into personal(reg,user,luser,dob,gender,contact,addr,city,state,country,image)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+m.get(8)+"','"+m.get(9)+"','"+ms.get(0)+"')");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                    
                    out.println("<script>"); 			
                    out.println("alert(\"Enter the Personal Details Succesfully\")");
                    out.println("</script>");
