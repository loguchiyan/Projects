    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       List<String> ms = new ArrayList<String>();
		...
		{   System.out.println("@@@@@@@@");
                    ...
                    PreparedStatement query=con.prepareStatement("insert into family(reg,user,pargur,fname,mname,foccup,moccup,noo,annual,pimage)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+m.get(8)+"','"+ms.get(0)+"')");
                    System.out.println(query);
                    query.executeUpdate();
                    System.out.println(query);
                    
                    out.println("<script>"); 			
                    out.println("alert(\"Enter the Family Details Details Succesfully\")");
                    out.println("</script>");
