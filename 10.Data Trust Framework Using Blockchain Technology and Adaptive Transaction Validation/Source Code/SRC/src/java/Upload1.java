...
public class Upload1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{   
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/faketranscation","root","root");    
                    PreparedStatement ps=con.prepareStatement("insert into card(cno,cvno,exp,mobile,email,aclim,password,sec,ans)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+m.get(9)+"')");
                    System.out.println(ps);
                    ps.executeUpdate();
                    System.out.println(ps);
                    out.println("<script>"); 			
                    out.println("alert(\"Add Card Succesfully\")");
                    out.println("</script>");
