  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       ...
       <h5 class="logo-text"> Fake Transcation  </h5>
     </a>
   </div>
   <ul class="sidebar-menu do-nicescrol">
    ...
    <i class="fa fa-user" aria-hidden="true"></i> <span>Profile</span>
      ...
      <li>
        <a href="urequest.jsp">
    <i class="fa fa-user" aria-hidden="true"></i> <span>Make Friends request and Responses</span>
        </a>
      </li>
...
%>
        ...
        <div class="col-lg-22" >
          <div class="card" >
            <div class="card-body">
                 <h5 class="card-title">Friend Requests and Responses</h5>
            ...
            Class.forName("com.mysql.jdbc.Driver");
                 Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/fakeproduct","root","root");
                           PreparedStatement ps=con.prepareStatement("Select * from ureg  where not user='"+user+"' ");
                           ResultSet r=ps.executeQuery();
                           while(r.next()){
                       %>
                       <tr>
                           <td><%=r.getString("sno")%></td>
                           <td><%=r.getString("user")%></td>
                             <td><%=r.getString("email")%></td>
                           <td><a href="sendreq.jsp?sno=<%=r.getString("sno")%>&&user=<%=r.getString("user")%>&&location=<%=r.getString("location")%>">Give Request</a></td>
                       </tr>
                       <%}%>
                   </table>
