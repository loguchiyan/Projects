...
<br>
 ...
 %>
     <% Class.forName("com.mysql.jdbc.Driver");
         ...
         <input type="hidden" class="form-control form-control-rounded" name="user" value="<%=user%>" >
         <input type='hidden' name='olotp' value='<%=otp%>'/>
            <input type='hidden' name='email' value='<%=email%>'/>
           <div class="form-group">
            <label for="input-6">Enter OTP</label>
            <input type="text" class="form-control form-control-rounded" name="otp" value="" required="">
           </div>
