      ...
      <li>
       ...
       <li>
        <a href="usreview.jsp" target="_blank">
          <i class="fa fa-star" aria-hidden="true"></i> <span>View Cart</span>
        </a>
      </li>
     <li>
        <a href="ufake.jsp" target="_blank">
          <i class="fa-solid fa-comments"></i><span>Order Responses </span>
        </a>
      </li>
...
/*        margin-left: 250px;*/
    ...
    .bg-image{
        ...
        <h2>View Products and Buy now </h2>
        <div class="col-lg-22" >
          <div class="card" >
            <div class="card-body">
...
%>
                <%
                 ...
                 PreparedStatement ps=con.prepareStatement("Select * from product1 where user='"+user+"' ");
                ...
                <tbody>
                 ...
                 <td><a href="cart1.jsp?sno=<%=sno%>&&user=<%=user%>&&pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>" style="color: Black; font-weight: bolder;">Buy Now</a></td>  
