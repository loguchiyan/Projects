 ...
 <%                    
      ...
      Class.forName("com.mysql.jdbc.Driver");
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded" name="pid" value="<%=rs.getString("pid")%>">
           </div>
          
         
          <div class="form-group">
            <label for="input-8">Product Brand</label>
            <input type="text" class="form-control form-control-rounded" name="pcat" value=" <%=rs.getString("pcat")%> " required="">                              
           </div>
          <div class="form-group">
            <label for="input-8">Product Name</label>
            <input type="text" class="form-control form-control-rounded" name="pname"  value=" <%=rs.getString("pname")%> " required="" >
           </div>
                <div class="form-group">
            <label for="input-8">Total Amount</label>
            <input type="text" class="form-control form-control-rounded" name="price" value=" <%=rs.getString("price")%> "  required="">
           </div>
           
                
              <div class="form-group">
            <label for="input-8">Quantity</label>
            <input type="number" class="form-control form-control-rounded" name="qua"  value="">
           </div>  
