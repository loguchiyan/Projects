...
<%
        ...
        <h2>Update the products Details</h2>
<div class="col-lg-6" style=" margin-left:300px;">
        <div class="card" >
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded" name="price" value="<%=price%>" required="">
           </div>
            <div class="form-group">
            <label for="input-8">Specification</label>
            <input type="text" class="form-control form-control-rounded" name="spec" value="<%=spec%>" required="">
           </div>
