             ...
             <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col" style="color: white;">P.Image</th>
                     <th scope="col" style="color: white;">Price</th>
                    
                    <th scope="col" style="color: white;">Specification</th>
                ...
                <tbody>
                 ...
                 <td><%=pcat%></td>
                 <td><%= pbrand%></td> 
                <td><img src="profile/<%=image%>" alt="image" style="width:50px; height:50px;"></td>
                 
                 
                 <td><%=price%></td>
                 <td><%=spec%></td>
                 <td><a href="update.jsp?pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>&&spec=<%=spec%>" style="color: Black; font-weight: bolder;">Update</a>/<a href="delete.jsp?sno=<%=sno%>">Delete</a></td>  
