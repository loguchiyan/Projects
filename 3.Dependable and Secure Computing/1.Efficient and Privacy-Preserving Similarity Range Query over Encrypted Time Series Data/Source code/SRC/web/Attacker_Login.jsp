                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                 <ul id="nav" style="color:black;">
                                    ...
                                    <li><a href="Broker_Login.jsp">Attribute Authority</a></li>
                                    ...
                                    <li class="active"><a href="Attacker_Login.jsp">Attackers</a></li>
                                </ul>
    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Attacker Login</h2><br><br>
                <form action='Attacker_Action'>
                <table>
