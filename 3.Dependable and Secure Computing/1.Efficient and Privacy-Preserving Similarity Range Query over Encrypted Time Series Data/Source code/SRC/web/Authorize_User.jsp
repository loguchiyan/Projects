                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                 <ul id="nav" style="color:black;">
                                    ...
                                    <li><a href="#">Menus</a>
                                        <ul class="dropdown">
                                              <li><a href="Authorize_User.jsp">Authorize Data Users</a></li>
                                            <li><a href="View_All_Provider.jsp">View All Owners</a></li>
                                            <li><a href="View_All_User.jsp">View All Users</a></li>
                                            <li><a href="keyword_request.jsp">View S-Key Request</a></li>
    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>View All Users And Authorize Them</h2><br><br>                
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        %>
                        <td style='font-weight: bold;'><a href='Accept_User?id=<%=r.getString("id")%>&&name=<%=r.getString("name")%>' style='color:green;'>Click Here</a></td>
                    </tr><%}}%>
                </table>
               </center>
        </div>
