    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Download Files</h2><br><br>
                <form action='Downlaod.jsp'>
                <table>
                    ...
                    <tr><td align='center' colspan="2"><input type="submit" Value='Downlaod' style="border-radius: 2px; width: 100px; height: 30px;padding: 5px; text-align: center; background-color: lightblue; color:darkblue;"</td></tr>
                </table></form><br>
           </center>
        </div>
    </section>
