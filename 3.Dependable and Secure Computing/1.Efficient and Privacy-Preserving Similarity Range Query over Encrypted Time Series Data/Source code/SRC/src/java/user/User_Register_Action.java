...
public class User_Register_Action extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into user_register(name,password,mobile,mail,city,profile)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+ms.get(0)+"')");
            ps.executeUpdate();
