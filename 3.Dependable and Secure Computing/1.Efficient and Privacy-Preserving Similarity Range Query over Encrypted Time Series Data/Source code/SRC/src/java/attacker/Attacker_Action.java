...
public class Attacker_Action extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(name.equalsIgnoreCase("attacker")&&pass.equalsIgnoreCase("attacker")){
            ...
            out.println("</script>"); 
            RequestDispatcher rd=request.getRequestDispatcher("Attacker_Login.jsp");
            rd.include(request, response);  
            }
