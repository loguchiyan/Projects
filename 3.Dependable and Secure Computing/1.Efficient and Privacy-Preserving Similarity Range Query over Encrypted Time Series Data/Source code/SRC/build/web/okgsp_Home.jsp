            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="hamiNav">
                         <a class="nav-brand" href="index.jsp"></a>
                     <!-- Navbar Toggler -->
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                    <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">Third<br> Authority</h2>
                                    <h3 data-animation="fadeInLeftBig" data-delay="400ms" data-duration="1s">Search Over Encrypted  <span>Cloud Data </span> Supporting Data Deduplication</h3>
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                   <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">OKGSP<br> Authority</h2>
                                    <h3 data-animation="fadeInLeftBig" data-delay="400ms" data-duration="1s">Service Composition <span>in</span> mobile cloud computing</h3>
                                   </div>
                            </div>
                        </div>
                    </div>
