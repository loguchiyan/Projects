    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Data Owner Login</h2><br><br>
                <form action='Provider_Login_Action'>
                <table>
                ...
                <h4>If New Owner?<a href="Provider_Register.jsp" style='color:brown; font-size: 15px;'>  SignUp Now</a></h4>
            </center>
        </div>
    </section>
