                                ...
                                <ul id="nav" style="color:black;">
                                    ...
                                    <li><a href="#">Menus</a>
                                         <ul class="dropdown">
                                            ...
                                            <li><a href="View_All_Transaction.jsp">View All Transactions</a></li><li><a href="ViewDuplicate.jsp">View Duplicate Files</a></li>
    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>View All Authorized Users</h2><br><br>                
                <table>
                    <tr>
