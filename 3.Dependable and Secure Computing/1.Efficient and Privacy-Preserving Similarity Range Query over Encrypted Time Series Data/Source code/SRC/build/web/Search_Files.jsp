    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Search Files by Keyword</h2><br><br>
                <form action='search1.jsp'>
                <table>
                    <tr><td style='color:blue; font-size: 20px;'><strong>Keyword: </strong></td><td><input type="text" name="key"  style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:blue; font-size: 20px;'><strong>K Value: </strong></td><td><input type="text" name="k"  style="border-radius: 2px;"></td></tr>
                    <tr><td align='center' colspan="2"><input type="submit" Value='Search' style="border-radius: 2px; width: 100px; height: 30px;padding: 5px; text-align: center; background-color: lightblue; color:darkblue;"</td></tr>
                </table></form><br>
           </center>
        </div>
    </section>
