    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Transfer File Request to Cloud-1</h2><br><br>                
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style='font-weight: bold;color:darkred;'><%=r.getString("Proxy_Status")%></td>
                        <td style='font-weight: bold;'><a href='Proxy_Request?oname=<%=name%>&&fkey=<%=r.getString("fkey")%>&&fname=<%=r.getString("fname")%>' style='color:Red;'>Request_Send</a></td>
                    </tr><%}%>
                </table>
               </center>
        </div>
