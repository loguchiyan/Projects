                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav" style="color:black;">
                                    <li class="active"><a href="Attacker_Home.jsp">Home</a></li>
                                    <li><a href="Attack.jsp">Attack Files</a></li>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                    <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">Attacker<br> Agent</h2>
