                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav" style="color:black;">
                                    ...
                                    <li class="active"><a href="Broker_Login.jsp">Attribute Authority</a></li>
                                    <li><a href="Proxy_Login.jsp">D-Cloud Server</a></li> 
                                    <li><a href="okgsp_Login.jsp">TA</a></li> 
                                    <li><a href="Cloud_Login.jsp">S-Cloud Server</a></li>
                                    <li><a href="Attacker_Login.jsp">Attackers</a></li>
                                </ul>
    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Attribute Authority Login</h2><br><br>
                <form action='Broker_Login_Action'>
                <table>
