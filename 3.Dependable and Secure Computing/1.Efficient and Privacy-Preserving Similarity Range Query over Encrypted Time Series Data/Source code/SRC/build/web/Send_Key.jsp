                            ...
                            <div class="classynav">
                                 <ul id="nav" style="color:black;">
                                    ...
                                    <li><a href="keyword_request.jsp">View Secret Key Request</a></li>
                                     <li class="active"><a href="Send_Key.jsp">Send Key to User</a></li>
    ...
    <section class="hami-price-plan-area section-padding-100-0">
        <div>
            <center>                
                ...
                <h2>Send Decryption Key to the Users</h2><br><br>                
                <table>
                    <tr>
                    ...
                    <%
                        ...
                        PreparedStatement ps=con.prepareStatement("select * from filereq where status='not-accept' ");
                    ...
                    <tr>
                        ...
                        <td style='font-weight: bold;'><a href='Key_Action.jsp?id=<%=r.getString("id")%>&&name=<%=r.getString("name")%>&&fname=<%=r.getString("fname")%>&&fkey=<%=r.getString("fkey")%>&&trap=<%=r.getString("trapdoor")%>' style='color:greenyellow;'>Send Key</a></td>
                    </tr><%}%>
                </table>
               </center>
        </div>
