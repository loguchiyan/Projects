...
public class Add extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{   
                    ...
                    PreparedStatement ps=con.prepareStatement("insert into product(pid,pname,qua,cost,cap,contact,address,city,image)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+ms.get(0)+"')");
