...
<body>
  ...
  <section id="hero">
	...
	<%
            ...
            PreparedStatement query=con.prepareStatement("SELECT * FROM sreg GROUP BY sid ");
            ResultSet rs=query.executeQuery();
            String sid=request.getParameter("sid");
            
        %>			
                <div class="container">
    <form action="viewsem.jsp" method="post"   > 
        <table algin="center">
            
                           <tr align="center">
                        
                    <td style="color:black; text-align: center;">Choose By Student ID : </td>
                    <td>
                        
                        <select name="sid" style="width: 171px;">
                            <option style=" text-align: center;">---Select--</option>
                        <%
                            while(rs.next())
                            {
                                %> 
                                    <option style=" text-align: center;"><%=rs.getString("sid")%></option>
                                <%
                            }
                        %>
                        </select>
                ...
                <tr align="center">
                    <td style="color: crimson;" colspan="2" align="center"><input type="submit" value="Search"></td>
                </tr>                
            </table>
            </form>
