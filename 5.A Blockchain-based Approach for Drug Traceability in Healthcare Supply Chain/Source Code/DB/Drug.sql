...
insert  into `cart`(`sno`,`user`,`did`,`dname`,`cate`,`sub`,`dprice`,`bank`,`cno`,`cvv`,`ifsc`,`qua`,`cost`,`image`,`hashkey`,`review`,`rating`,`status`) values (9,'Lakshmi','DID3419','Statins','Heartattack','Heartstrok','200','Bank of Baroda','8682384238723','354','BOB0012','2','100','statin.webp','c5a7ed4914038532b2b790e469b1c8dd','Good','4','Order Confirmed'),(10,'Lakshmi','DID1775','Platorich ','Fever','Dengu Fever','45','Bank of Baroda','3463456455','354','BOB0012','2','100','platorich-dengue-fever.webp','35f02fda805534b02558a946c2d072cf','Easily cure ','5','Order Confirmed');
...
insert  into `category`(`sno`,`cate`) values (1,'Fever'),(2,'Heartattack'),(3,'Kidney Stone'),(4,'Fat Liver'),(5,'Stomach Pain');
...
insert  into `search1`(`sno`,`user`,`cate`) values (53,'Lakshmi','Heartattack'),(54,'Lakshmi','Heartattack'),(55,'Lakshmi','Heartattack'),(56,'Lakshmi','Fever'),(57,'Lakshmi','Fever'),(58,'Lakshmi','Heartattack'),(59,'Lakshmi','Fever');
...
insert  into `upload`(`sno`,`did`,`cate`,`sub`,`dname`,`dprice`,`des`,`image`,`hashkey`,`datee`) values (1,'DID4080','Fever','Typoid Fever','Fluoroquinolones','12','Antibotic','Fluoroquinolone.webp','02dc93279f75c1361a516b053567eb04','2023-02-10 16:59:00'),(2,'DID3419','Heartattack','Heartstrok','Statins','200','Prevents Heart Stroke','statin.webp','02dc93279f75c1361a516b053567eb04','2023-02-10 16:59:00'),(3,'DID1775','Fever','Dengu Fever','Platorich ','45','This is cure all the Symptoms related to dengue','platorich-dengue-fever.webp','02dc93279f75c1361a516b053567eb04','2023-02-10 16:59:00');
...
insert  into `ureg`(`sno`,`user`,`pass`,`email`,`contact`,`location`) values (9,'Lakshmi','lakshmi','lakshmi@gmail.com','878738573','null'),(10,'Lakshmi','Lakshmi','lakshmi@gmail.com','978784327','Chennai'),(11,'Camy','camy','camy@gmail.com','8877782345','Chennai');
