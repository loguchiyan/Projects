     ...
     h1{
         ...
         th{
             color:gold;
                   ...
                   <h1 style=" text-align:center; margin-top:-50px;">View Ordered Products</h1>
                   <br>
                       ...
                       <table>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from cart ");
	            	...
	            	while(rs.next()){
                          ...
                          <tr>
                              ...
                              <td><%=sub%></td>
                              <td><%=dprice%></td>
                              <td><a href="hash.jsp?sno=<%=sno%>" style=" text-decoration:none;"><%=hashkey%> <br><span style=" color: #bd2130;">Update Hash Value</span></a></td>
                              <td><a href='update.jsp?sno=<%=sno%>' style=" color:#3dcac8; text-decoration:none;"><%=status%></a></td><%}%>
                          </tr>
