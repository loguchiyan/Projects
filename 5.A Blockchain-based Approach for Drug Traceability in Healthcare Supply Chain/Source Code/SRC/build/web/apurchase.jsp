     ...
     h1{
         ...
         th{
             color:gold;
                   ...
                   <h1 style=" text-align:center; margin-top:-50px;">View Purchased Products</h1>
                   <br>
                       ...
                       <table>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from cart where status='Order Confirmed' ");
