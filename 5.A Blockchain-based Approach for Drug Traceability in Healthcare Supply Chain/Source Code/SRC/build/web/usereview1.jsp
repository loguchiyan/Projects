              ...
              <%
                 ...
                 Class.forName("com.mysql.jdbc.Driver");
                     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/block","root","root");
                           ...
                           PreparedStatement ps=con.prepareStatement(" SELECT * FROM cart where sno='"+sno+"' ");
                     ...
                     %>
                      ...
                      <form action="usereview.jsp" method="post" >
                          <center>
                        <table style="margin-top:30px; width: 80%; margin-left:380px; font-size: 15px;">
                            <input type="hidden" name="sno"  value="<%=sno%>">
                           
                         <tr><td>Review</td><td><input type="text" name="review" value=""></td></tr>
                         <tr><td>Rating</td><td><select name="rating" style=" width:180px; height:30px;"><option>--Choose--</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                        <option>5</option>
                         ...
                         <tr><td align="center" colspan="2"><button type="submit" style="border-radius: 20px; height: 40px; margin-left:-200px; width:120px;background-color: #3dcac8; ">Submit</button></td></tr>
