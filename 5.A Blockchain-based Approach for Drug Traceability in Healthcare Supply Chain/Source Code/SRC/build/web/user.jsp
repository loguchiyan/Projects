    ...
    <header id="header" class="header">
        <div class="container">
            ...
            <div class="row">
                ...
                <br>
                <br>
                 <h6 style=" margin-left:240px;">User Login !!!!</h6>
                 <br>
                 <form action="uloginc.jsp" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button"style=" margin-left:40px; width:100px; height: 40px;">SIGN UP</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ureg.jsp" style=" text-decoration: none;">New User</a>
                        </div>
                    </form>
                    </div> 
            </div> 
