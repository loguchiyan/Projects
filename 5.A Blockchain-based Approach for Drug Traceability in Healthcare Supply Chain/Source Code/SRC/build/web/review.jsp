...
<h1 style=" text-align:center;">Review and Rating For Purchased Products </h1>
              <%
              ...
              %>
                       ...
                       <%
                           PreparedStatement ps=con.prepareStatement(" SELECT * FROM cart  where user='"+user+"' and status='Order Confirmed' ");
                       ...
                       <tr>
                           ...
                           <td><center><img src="profile/<%=r.getString("image")%>" style=" width:100px; height:100px;" ></center></td>
                              <td><%=r.getString("sub")%></td>
                               ...
                               <td ><a href="usereview1.jsp?sno=<%=sno%>" style='color:#3dcac8; text-decoration: none;'>Review and Rating</a></td>
                               <%}%>
