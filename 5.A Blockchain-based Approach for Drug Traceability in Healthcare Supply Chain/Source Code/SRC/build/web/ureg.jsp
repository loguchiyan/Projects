        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll-active" href="index.html" style="color: #3dcac8; ">HOME <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="admin.jsp" style=" color: #3dcac8;">ADMIN</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="user.jsp" style=" color: #3dcac8;">USER</a>
                    </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-xl-5">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/loginn.jpg" alt="alternative" style=" border-radius:10%; width:400px; ">
                                            </div> 
                                        </div> 
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    <style>
                        ...
                        .form-control-submit-button{text-align:center }
                        </style>
                       
                <br>
                <br>
                 <h6 style=" margin-left:240px;">New User!!!!</h6>
                 <br>
                
                 
                 <form action="uregaction.jsp" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control-input" name="user" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control-input"   name="contact" required>
                            <label class="label-control">Contact Number</label>
                        </div>
                     <div class="form-group">
                            <input type="text" class="form-control-input"   name="location" required>
                            <label class="label-control">Location</label>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button" style=" margin-left:50px; width:100px; height: 40px;">Submit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                    </form>
                    </div> 
            </div> 
