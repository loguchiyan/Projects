...
<body data-spy="scroll" data-target=".fixed-top">
  ...
  <h1 style=" text-align:center; margin-left:440px;">Make a Payment </h1>
              <%
                 ...
                 Class.forName("com.mysql.jdbc.Driver");
                     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/block","root","root");
                           ...
                           PreparedStatement ps=con.prepareStatement(" SELECT * FROM upload  where did='"+did+"' ");
                     ...
                     %>
                      ...
                      <form action="buyaction.jsp" method="post" >
                          <center>
                        <table style="margin-top:30px; width: 80%; margin-left:380px; font-size: 15px;">
                         ...
                         <tr><td>Drug ID</td><td><input type="text" name="did" value="<%=did%>"></td></tr>
                         <tr><td>Bank Name</td><td><input type="text" name="bank" value=""></td></tr>
                         <tr><td>Card Number</td><td><input type="text" name="cno" value=""></td></tr>
                         <tr><td>CVV Number</td><td><input type="text" name="cvv" value=""></td></tr>
                         <tr><td>IFSC Code</td><td><input type="text" name="ifsc" value=""></td></tr>
                         <tr><td>Quantity</td><td><input type="text" name="qua" value=""></td></tr>
                         <tr><td>Cost</td><td><input type="text" name="cost" value=""></td></tr>
