    ...
    <header id="header" class="header">
        <div class="container">
            ...
            <div class="row">
                ...
                <br>
                <br>
                 <h6 style=" margin-left:220px;">Admin Login !!!!</h6>
                 <br>
                 <form action="aloginc.jsp" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button"style=" margin-left:80px; width:100px; height: 40px;">SIGN UP</button>
                        </div>
                    </form>
