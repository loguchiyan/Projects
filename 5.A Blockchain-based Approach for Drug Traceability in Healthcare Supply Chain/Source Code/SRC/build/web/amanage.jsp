     ...
     h1{
         ...
         table,tr,td{
             ...
             margin-left:-40px;
                   ...
                   <h1 style=" text-align:center; margin-top:-50px;">View and Manage Details</h1>
                   <br>
                   
                    <form action="ablock.jsp" method="post"  >
                                <center>
                                <table>
                                    
                           
                            <tr><td>Drug Category Based On Block:</td><td>
                                    
                                    
                                    
                                    
                                    
                            <select name="cate" style=" width:195px; height:34px;">
                                <option selected="disabled">Choose One</option>
                                    <%
                                             Class.forName("com.mysql.jdbc.Driver");
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/block","root","root");
                        PreparedStatement query=con.prepareStatement("select * from upload group by cate");
