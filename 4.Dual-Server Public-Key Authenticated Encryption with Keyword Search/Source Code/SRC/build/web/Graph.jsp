        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main >
                   ...
                   <h1 style=" font-size:30px; color: blue; font-family: cambria; align:centre; font-weight:Bolder; margin-left: 285px; margin-top: 95px; "> Overall Result Through Graph<h1>
                ...
                <br>
                <br>
                <a href="Graph1.jsp"><h4>Result of Number of the attribute</h4></a> 
