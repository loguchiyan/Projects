    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
               ...
               <h2 style="margin-left: 420px;font-size:25px;font-family: Cambria; font-weight: bolder ;margin-bottom:-52px; color:blue;">Test Server Login </h2><br>
               <form action="clogaction.jsp">
