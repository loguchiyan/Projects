    ...
    <body class="sb-nav-fixed">
       ...
       <div id="layoutSidenav_content">
                <main>
                   ...
                   <h3 style=" font-size:32px; font-family: cambria; align:centre; font-weight:Bolder; margin-left: 44px; margin-top: 30px; color:brown; ">Dual-Server Public-Key Authenticated Encryption with Keyword Search</h3>
                   <a style="background-image: url(images/cld.jpg);"></a> 
                   <center> <img src="images/cloud3.gif" alt="Italian Trulli" width="700" height="600"></center>
            </div>
        </div>
