...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:brown; font-family:Cambria;font-weight: bold; font-size: 30px; ">View all File Upload Status</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    String id=session.getAttribute("id").toString(); 
                        ...
                        PreparedStatement query=con.prepareStatement("select * from cloudreq  Where id='"+id+"'and user='"+user+"' ");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td style="color:purple;"><%=rs.getString("status")%></td>
