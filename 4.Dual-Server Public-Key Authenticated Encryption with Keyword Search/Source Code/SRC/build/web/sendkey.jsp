...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:blue; font-family:Cambria;font-weight: bold; font-size: 30px; ">View user request and accept</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    
                        ...
                        PreparedStatement query=con.prepareStatement("select * from urequest  Where cloud='Accept'and internal='Accept '");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="keyaccept.jsp?files=<%=rs.getString("files")%>&&id=<%=rs.getString("id")%>&&user=<%=rs.getString("user")%>&&mail=<%=rs.getString("email")%>" style="color:green; "> Send Key </a></td></tr>
