...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:brown; font-family:Cambria;font-weight: bold; font-size: 30px; ">View all  DataUser and  Authentication!</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="inuactive.jsp?id=<%=rs.getString("id")%>" style="color:green; "><%=rs.getString("status")%></a></td></tr>
