...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:black; font-family:Cambria;font-weight: bold; font-size: 30px; ">View Files and Send Request!</h2><br><br>
   <div class="container">
       <br>
      ...
      Class.forName("com.mysql.jdbc.Driver");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="downreq.jsp?id=<%=rs.getString("id")%>&&name=<%=rs.getString("user")%>&&file=<%=rs.getString("files")%>" style="color:green; ">Send File Request</a></td></tr>
