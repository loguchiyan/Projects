...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:black; font-family:Cambria;font-weight: bold; font-size: 30px; color:brown; ">View and Manage Files!</h2><br><br>
   <div class="container">
       <br>
   ...
   <%                    
      ...
      Class.forName("com.mysql.jdbc.Driver");
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload Where id='"+id+"' and user='"+name+"'");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="managefile.jsp?id=<%=rs.getString("id")%>&&name=<%=rs.getString("user")%>" style="color:green; ">Delete</a></td></tr>
