    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
               ...
               <h2 style="margin-left: 420px;font-size:25px;font-family: Cambria;color: blue; font-weight: bolder ;margin-bottom:-52px;"><b>Data User Register</b> </h2><br>
               <form action="uregaction.jsp">
