...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:brown; font-family:Cambria;font-weight: bold; font-size: 30px;">View all user Request</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    
                        ...
                        PreparedStatement query=con.prepareStatement("select * from urequest  Where internal='Accept' ");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="uinaccept.jsp?id=<%=rs.getString("id")%>" style="color:green; "><%=rs.getString("internal")%></a></td></tr>
