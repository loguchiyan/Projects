                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                                <nav class="sb-sidenav-menu-nested nav" style=" font-size:20px;margin-top:39px;font-family: cambria;font-weight: bold;">
                                    ...
                                    <a class="nav-link" href="cloud.jsp">Upload Files </a>
                                    <a class="nav-link" href="kgc.jsp">View and Manage Files</a>
            ...
            <div id="layoutSidenav_content">
                <main >
                  ...
                  <style>
                        ...
                        <form action="reqaction.jsp">
                            <br><br><h2 align="center" style="color:brown;"> Send  Request for Upload File</h2>
                        <table style="font-family: cambria; font-size:20px;font-weight: bold;box-shadow: #117a8b;" align="center">
                            <br><br> <tr><td><storng>Send request to Server:</storng></td><td><input type="submit" value="Send Request"></td></tr>
                        </table>
                        </form>   
