...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:brown; font-family:Cambria;font-weight: bold; font-size: 30px; ">View user request and accept</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    
                        ...
                        PreparedStatement query=con.prepareStatement("select * from urequest  Where cloud='Waiting' ");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <td > <a href="uaccept.jsp?id=<%=rs.getString("id")%>" style="color:green; "><%=rs.getString("cloud")%></a></td></tr>
