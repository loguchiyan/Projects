...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class ="header-text">
            ...
            <center>
            <h2  style=" color:blue; font-family:Cambria;font-weight: bold; font-size: 30px; ">View all Downloads !</h2><br><br>
  ...
  <%                    
                        ...
                        PreparedStatement query=con.prepareStatement("select * from urequest Where fkey!='null'");
                        ...
                        while(rs.next()){
                         %>
                            ...
                            <%}%></table> 
                            <br><br><br><br></center></div> </div></div>  
