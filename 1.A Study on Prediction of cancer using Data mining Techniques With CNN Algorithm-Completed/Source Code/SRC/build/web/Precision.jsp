...
int a=0,b=0,c=0,d=0;String topic="";
   bar.addValue(0.73,"Existing","Existing");
   bar.addValue(p,"Proposed","Proposed");
  

 JFreeChart BarChartObject=ChartFactory.createBarChart("Precision of Existing and Proposed Work ","Search keyword based on rank","Precision",bar,PlotOrientation.VERTICAL,true,true,false);
