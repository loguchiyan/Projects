...
int a=0,b=0,c=0,d=0;String topic="";
   bar.addValue(0.98,"Existing","Existing");
   bar.addValue(fm,"Proposed","Proposed");
  

 JFreeChart BarChartObject=ChartFactory.createBarChart("F1 Measure of Existing and Proposed Work ","Search keyword based on rank","F1 Measure",bar,PlotOrientation.VERTICAL,true,true,false);
