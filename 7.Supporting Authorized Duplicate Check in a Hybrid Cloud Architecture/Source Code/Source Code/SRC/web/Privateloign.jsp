...
<div class="banner-area banner-2">
  ...
  <h2 style="margin-top: -150px;  color: white;"> Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
   <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Private Cloud Login</h2><br>
        <form action="Private_Login_Action" >
        <table>
