...
<div class="banner-area banner-2">
  ...
  <h2 style="margin-top: -150px;color: whitesmoke"> Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
   <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Trust Authority Login</h2><br>
        <form action="TA_Login_Action" >
        <table>
