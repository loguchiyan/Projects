        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="row">
                      ...
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Private Cloud Key Enter Them</h2><br>
                    
                        <form action="req3.jsp">
                            <table align="center"><br>
                                <tr><td style='color:white; font-size: 20px;'><strong>Enter Key:</strong></td><td><td><input type="text" name="key" value="" style="border-radius: 2px; width: 280px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
                                <tr><td style='color:white; font-size: 20px;'><strong>Secret Key:</strong></td><td><td><input type="text" name="skey" value="" style="border-radius: 2px; width: 280px;">&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>  
                                <tr><td><input type="submit" Value='Check it !' class="btn btn-white btn-circled"></td></tr>
                               
                            </table></form>
                 <br><br><a href="Uploadrequest.jsp" class="btn btn-white btn-circled">Click to Back</a>
