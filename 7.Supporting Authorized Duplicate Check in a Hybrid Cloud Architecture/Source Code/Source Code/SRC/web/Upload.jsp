            ...
            <div class="container">
                <div class="row">
                    ...
                    h3{
                      ...
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Upload File</h2><br>
                    <%
                ...
                <table>
                    ...
                    <tr><td style='color:sandybrown; font-size: 20px;'><strong>File key: </strong></td><td><input type="text" name="pkey" value='<%=x%>' style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:sandybrown; font-size: 20px;'><strong>Date: </strong></td><td><input type="text" name="date" value="<%=d%>" style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:sandybrown; font-size: 20px;'><strong>Trapdoor: </strong></td><td><input type="text" name="tkey" value="<%=tkey%>" style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:sandybrown; font-size: 20px;'><strong>Type: </strong></td><td><input type="text" name="type" value="<%=type%>" style="border-radius: 2px;"></td></tr>
                    <tr><td style='color:sandybrown; font-size: 20px;'><strong>Upload File:</strong></td><td><input type="file" name="file" style="border-radius: 2px;"></td></tr>
                    <tr><td align='center' colspan="2"><input type="submit" Value='Upload' class="btn btn-white btn-circled "></td></tr>
                </table></form><br>    
