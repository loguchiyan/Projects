...
<div class="banner-area banner-2">
  ...
  <h2 style="margin-top: -150px; color: whitesmoke">Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
   <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Data User Login</h2><br>
        <form action="User_Lgoin_Action" >
        <table>
          <tr><td><strong>Username: </strong></td><td><input type="text" name="user" style="border-radius: 2px;" required></td></tr>
          <tr><td><strong>Password: </strong></td><td><input type="password" name="pass" style="border-radius: 2px;"  required></td></tr>
          <tr><td align="center" colspan="2"><button type="submit" class="btn btn-white btn-circled">LOGIN</button></td></tr>
         </table></form>
