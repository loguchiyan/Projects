            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                      ...
                      <h2 style="margin-top: -100px;"style="color: white;"> Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Public Cloud Key Enter them</h2><br>
                    
                    <form action="req1.jsp">
                        <table align="center"><br><tr><td style='color:white; font-size: 20px;'><strong>Enter Key:</strong></td><td><td><input type="text" name="key" value="" style="border-radius: 2px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" Value='Check it !' class="btn btn-white btn-circled"></td></tr></table></form>
