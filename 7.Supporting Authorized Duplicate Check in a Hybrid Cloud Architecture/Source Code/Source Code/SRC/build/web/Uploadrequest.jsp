            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                      ...
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Request sent & Enter the Access Key them</h2><br>
                    <form action="request.jsp">
                        <table><br><tr><td style='color:white; font-size: 20px;'><strong>Send Request:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td>
                                <select name="p1" style="border-radius: 2px; width: 200px; height: 50px; font-family: cursive;">
				<option value="Public Cloud">Public Cloud</option>
				<option value="Private Cloud">Private Cloud</option>
                                </select><td>&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="submit" class="btn btn-white btn-circled Value='Requset' style="border-radius: 2px; margin-left:45px; width: 100px; height: 30px;padding: 5px; text-align: center; background-color: lightblue; color:darkblue;"></td></table></form>
                        <br><br><br>
                        <table> <tr><td><a href="pulreq.jsp"><h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Public Cloud Key</h2></a></td>
                            <td><a href="prireq.jsp"><h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Private Cloud Key</h2></a></td><br>
                    </table>
                        </div>
                    </div>
                </div>
