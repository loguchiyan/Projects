        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                        <div class="banner-content content-padding">
                              <p style='margin-top: -75px;'>Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</p>

                            <h2 class="banner-title">Download File</h2><br>
                                                <style>
                    table{
                        line-height: 25px;
                        width: 50%;
                ...
                <table>
                    ...
                    <tr><td style='color:blue; font-size: 20px;'><strong>Secret Key: </strong></td><td><input type="text" name="skey"  style="border-radius: 2px;"></td></tr>
                ...
                </table></form><br><a href="Download.jsp" class="btn btn-white btn-circled">Click to Back</a>
                        </div>
                    </div>
                </div>
            </div>
