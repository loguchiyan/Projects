...
<nav class="navbar navbar-expand-lg fixed-top trans-navigation">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="images/" alt="" class="img-fluid b-logo">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mainNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="Userlogin.jsp">User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="TAlogin.jsp">Trust Authority</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="Privateloign.jsp">Private Cloud</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="Publicloign.jsp">Public Cloud</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="banner-area banner-2">
  ...
  <h2 style="margin-top: -150px ;color: whitesmoke;"> Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
   <div id="content" class="p-4 p-md-5 pt-5" >
        <h2 style="color:white; text-shadow: 2px 3px 3px; margin-left: 150px;font-family: cambria;font-weight: bold; font-size: 30px;">Data User Registration Page</h2><br>
