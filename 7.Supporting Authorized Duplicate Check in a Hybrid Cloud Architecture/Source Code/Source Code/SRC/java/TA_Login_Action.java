 ...
 * @author ADMIN
 */
@WebServlet(urlPatterns = {"/TA_Login_Action"})
public class TA_Login_Action extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name=request.getParameter("user");
            ...
            if(name.equalsIgnoreCase("Authority")&&pass.equalsIgnoreCase("Authority")){
                ...
                out.println("alert(\"Welcome Trust Authority\")");
                out.println("</script>"); 
            ...
            out.println("</script>"); 
            RequestDispatcher rd=request.getRequestDispatcher("TAlogin.jsp");
            rd.include(request, response);  
            }
