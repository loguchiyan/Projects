          ...
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="Cloud_Home.jsp" class="d-flex align-items-center">
                ...
                <li>
                  <a href="User.jsp" class="d-flex align-items-center">
                    <img src="images/2.png" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">View User</span>
                    </div>
                  </a>
                </li>   <li>
                  <a href="View_File.jsp" class="d-flex align-items-center">
                    <img src="images/3.png" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">View File</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="VCheck.jsp" class="d-flex align-items-center">
                   ...
                   <li>
                  <a href="Graph.jsp" class="d-flex align-items-center">
                    <img src="images/5..jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">Graph</span>
                    </div>
                  </a>
                </li>   
                <li>
...
PreparedStatement ps = con.prepareStatement("select count(status) as count, status from audit group by status ");
            ResultSet rs = ps.executeQuery();
            while(rs.next())
            {
                plan = rs.getString("status");
                id=rs.getInt("count");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No of Attribute Auditing check (ms)"
	},
	axisY: {
		suffix: ""
	},
	axisX: {
		title: "Auditing Check Intergity"
	},
	data: [{
		type: "column",
...
<style>
    .w3-black, .w3-hover-black:hover{ background-color:white!important}
    
body, h1,h2,h3,h4,h5,h6 {font-family: "Montserrat", sans-serif}
.w3-row-padding img {margin-bottom:-192px}
/* Set the width of the sidebar to 120px */
.w3-sidebar {width: 320px;background: #e91e63; }
/* Add a left margin to the "page content" that matches the width of the sidebar (120px) */
#main {margin-left: 220px;margin-top:-220px; width: 520px; }
