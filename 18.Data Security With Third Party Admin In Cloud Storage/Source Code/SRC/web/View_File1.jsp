    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-lg-8">
            ...
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 284px;">View all Upload</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 150%;
                    ...
                    <tr>
                        ...
                        <td style='font-weight: bold; color: crimson'><%=rs.getString("image")%></td>
