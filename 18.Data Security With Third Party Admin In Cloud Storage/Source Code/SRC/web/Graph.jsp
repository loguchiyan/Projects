  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="">
            <div style="margin-left: 400px; margin-top: -445px; font-family: cursive; font-size: 15px">
            <h1 align="center">Graph</h1>
            <h2 style="margin-bottom: 23px;"><a href="Graph1.jsp">Number of Attribute(Authorized and Unauthorized)</a></h2>
            <h2><a href="Graph2.jsp">Number of Request</a></h2>
            <h2><a href="Graph3.jsp">Number of Auditing Checking</a></h2>
            </div></div>
      </div>
    </div>
