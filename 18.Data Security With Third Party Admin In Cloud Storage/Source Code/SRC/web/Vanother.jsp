  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-lg-8">
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 8px;">View Another User File & Send Request</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 80%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Send Request to Key</td>
                    </tr>
                        ...
                        <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold;color:red"><a href='View_File.jsp?name=<%=name%>&&fkey=<%=rs.getString("fkey")%>&&reg=<%=rs.getString("reg")%>&&trap=<%=rs.getString("trapdoor")%>&&image=<%=rs.getString("image")%>' style='color:Red;'>View</a></button></td>
                        <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold"><a href='Req_File.jsp?trap=<%=rs.getString("trapdoor")%>&&fkey=<%=rs.getString("fkey")%>&&reg=<%=id%>&&name=<%=name%>&&file=<%=rs.getString("image")%>' style='color:Green;'>Send key Request</a></button></td>
                     </tr><%}%>
