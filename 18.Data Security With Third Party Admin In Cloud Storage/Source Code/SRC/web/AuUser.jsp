  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class=""> <header><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 380px; margin-top: -280px;">View all User & Authorized them</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 90%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Email</td>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from ureg where status='Unauthorized'");
                        ...
                        <td style='font-weight: bold;'><%=rs.getString("email")%></td>
                        <td style='font-weight: bold;'><%=rs.getString("cont")%></td>
                        <td style='font-weight: bold;'><%=rs.getString("address")%></td>
                        <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold;color:Green"><a href='Autho_User.jsp?name=<%=rs.getString("name")%>&&id=<%=rs.getString("id")%>' style='color:Red;'>Authorized</a></button></td>
                     </tr><%}%>
