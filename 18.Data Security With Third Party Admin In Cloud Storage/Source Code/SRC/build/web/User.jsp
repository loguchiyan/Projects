    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
            ...
            <div class="featured-user  mb-5 mb-lg-0">
              <ul class="list-unstyled">
                ...
                <li>
                  ...
                  <a href="View_File1.jsp" class="d-flex align-items-center">
        ...
        <div class="col-lg-8">
            ...
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 304px;">View all Users</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 150%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='font-weight: bold; color:red'><%=rs.getString("status")%></td>
                         </tr><%}%>
                </table></div>
      </div>
    </div>
