  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-lg-8">
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; font-size:25px;"> 
</h1></header>
							 <center>                
                <style>
                    table{
            ...
            <h2 style="font-family: cambria; margin-left: 400px;">&nbsp;&nbsp;Upload file to <%=name1%></h2>
		 <%
                    Random r = new Random(); 
