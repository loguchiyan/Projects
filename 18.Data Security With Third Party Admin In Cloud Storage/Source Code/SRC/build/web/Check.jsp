  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
         ...
         <div class="row">
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
                ...
                <li>
                  <a href="TPA_Home.jsp" class="d-flex align-items-center">
                  ...
                  <a href="AuUser.jsp" class="d-flex align-items-center">
                    <img src="images/2.png" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">View User & Authorized</span>
                    </div>
                  </a>
                </li>
                <li>
                <li>
                  <a href="Check.jsp" class="d-flex align-items-center">
                    <img src="images/3.png" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">View Auditing File</span>
                    </div>
                  </a>
                </li>
                <li>
        ...
        <div class=""> <header><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 380px; margin-top: -280px;">View Auditing Request & Notify send</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 90%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Fkey</td>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from audit where status='Waiting'");
                        ...
                        <td style='font-weight: bold;'><%=rs.getString("fname")%></td>
                        <td style='font-weight: bold;'><%=rs.getString("status")%></td>
                        <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold;color:Green"><a href='Auditchi.jsp?name=<%=rs.getString("name")%>&&id=<%=rs.getString("id")%>&&fkey=<%=rs.getString("fkey")%>&&trap=<%=rs.getString("trap")%>&&fname=<%=rs.getString("fname")%>' style='color:Red;'>Auditing Check</a></button></td>
                     </tr><%}%>
