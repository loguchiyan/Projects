  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-lg-8">
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 84px;"align="center">View File With Encrypted </h1></header><br>
            ...
            String book=sb.toString();
                       ...
                       <center>
                        ...
                        <textarea rows="15" cols="40" style="width:400px;height: 250px; margin-left: 275px;"><%=book%></textarea><br><br>
