...
PreparedStatement ps = con.prepareStatement("select count(status) as count, status from request group by status ");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No of Attribute Request (ms)"
	},
	axisY: {
		suffix: ""
	},
	axisX: {
		title: "Percentage of Key Send"
	},
	data: [{
		type: "column",
...
.w3-sidebar {width: 320px;background: crimson; }
