...
PreparedStatement ps = con.prepareStatement("select count(status) as count, status from ureg group by status ");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No of Attribute (ms)"
	},
	axisY: {
		suffix: ""
	},
	axisX: {
		title: "Authorized and Unauthorized"
	},
	data: [{
		type: "column",
