  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <ul>
          <li ><a href="Attacker_Home.jsp"><span>Home Page</span></a></li>
          <li class="active"><a href="Att.jsp"><span>Attack File</span></a></li>
        ...
        <div class="col-lg-8">
            ...
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 184px;">View File & Attack</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 80%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='font-weight: bold; color: crimson'><%=rs.getString("fkey")%></td>
                       ...
                       <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold"><a href='Attack_File.jsp?trap=<%=rs.getString("trapdoor")%>&&fkey=<%=rs.getString("fkey")%>&&id=<%=rs.getString("reg")%>&&name=<%=rs.getString("name")%>&&file=<%=rs.getString("image")%>' style='color:Green;'>Attack</a></button></td>
                     </tr><%}%>
                </table>    
        </div>
      </div>
