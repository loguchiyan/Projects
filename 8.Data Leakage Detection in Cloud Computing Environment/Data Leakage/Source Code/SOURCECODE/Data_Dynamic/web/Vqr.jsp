         ...
         <div class="row">
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
             <div class="menu_nav">
        <ul>
          <li ><a href="User_Home.jsp"><span>Home Page</span></a></li>
          <li class="active"><a href="Upload.jsp"><span>Upload File</span></a></li>
           <li><a href="Vqr.jsp"><span>View Details</span></a></li>
          <li><a href="Manage.jsp"><span>Manage File</span></a></li>
          <li><a href="Vanother.jsp"><span>View all File</span></a></li>
            ...
            <style>
                ...
                <table>
                    <tr>
                       ...
                       <td style='color:navy; font-weight: bold;'>Generate</td>
                        ...
                        %>
                      <tr>
                         <td style='color:navy; font-weight: bold;'><%=rs.getString("reg")%></td>
                       <td style='color:navy; font-weight: bold;'><a href="generate.jsp?reg=<%=rs.getString("reg")%>&&name=<%=rs.getString("name")%>&&fkey=<%=rs.getString("fkey")%>&&dates=<%=rs.getString("dates")%>&&trapdoor=<%=rs.getString("trapdoor")%>&&image=<%=image%>">Generate</a></td>
...
<!--                        <td style='font-weight: bold;'><%=rs.getString("reg")%></td>
                        <td style='font-weight: bold;'><a href="generate.jsp?reg=<%=rs.getString("reg")%>&&name=<%=rs.getString("name")%>&&fkey=<%=rs.getString("fkey")%>&&dates=<%=rs.getString("dates")%>&&trapdoor=<%=rs.getString("trapdoor")%>&&image=<%=image%>">Generate</a></td> 
                      </tr>-->
