  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
         ...
         <div class="row">
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
                     <ul>
          <li ><a href="TPA_Home.jsp"><span>Home Page</span></a></li>
          <li class="active"><a href="AuUser.jsp"><span>View User & Authorized</span></a></li>
          <li><a href="Check.jsp"><span>View Auditing Request</span></a></li>
        ...
        <div class=""> <header><h1 class="tm-text-shadow" style="font-family: cursive; font-size:18px; margin-left: 380px; margin-top: -180px;">View Auditing Request & Notify send</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 90%;
