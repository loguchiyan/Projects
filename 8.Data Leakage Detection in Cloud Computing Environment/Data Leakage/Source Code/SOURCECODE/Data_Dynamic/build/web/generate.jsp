...
<%
 ...
 %>
                            <form  action="QRAction.jsp">
                                        <input type="hidden" id="text" value="<%=id%>">
                                        <input type="hidden" id="text" value="<%=name%>">
                                        <input type="hidden" id="text" value="<%=dates%>">
                                        <input type="hidden" id="text" value="<%=fkey%>">
                                        <input type="hidden" id="text" value="<%=image%>">
                                       <input type="hidden" id="text" value="<%=trapdoor%>">
                                        
   <img id='barcode' 
  src="https://api.qrserver.com/v1/create-qr-code/?data=reg=<%=id%>&&name=<%=name%>&&dates=<%=dates%>&&fkey=<%=fkey%>&&image=<%=image%>&&trapdoor=<%=trapdoor%> &amp;size=250x250" 
            alt=""  style=" margin-left:300px;"
            title="HELLO" /><br><br>
