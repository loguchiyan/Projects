      ...
      <div class="row align-items-center text-center text-md-left">
         ...
         <div class="row">
          <div class="col-lg-3">
            ...
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 208px;">View Send Request & Status</h1></header><br>
            <div><style>
                    table{
                        line-height: 25px;
                        width: 120%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='font-weight: bold; color:red'><%=rs.getString("fkkey")%></td>
