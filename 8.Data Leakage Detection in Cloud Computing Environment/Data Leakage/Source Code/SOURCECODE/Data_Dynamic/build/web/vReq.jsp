  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
          ...
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
              <ul class="list-unstyled">
                <li>
                  <a href="KGC_Home.jsp" class="d-flex align-items-center">
                ...
                <li>
                  <a href="vReq.jsp" class="d-flex align-items-center">
                    <img src="images/2.png" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                      <span class="d-block">Request & Send Key</span>
                    </div>
                  </a>
                </li>
                <li>
        ...
        <div class="">
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 484px; margin-top:-234px;">View Request & Send Key</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 90%;
                ...
                <table>
                    <tr>
                        ...
                        <td style='font-weight: bold; color: crimson'><%=rs.getString("fkkey")%></td>
                       ...
                       <td style='font-weight: bold; color: red;'><button style="width:150px; font-weight: bold"><a href='Key_File.jsp?trap=<%=rs.getString("trap")%>&&fkey=<%=rs.getString("fkey")%>&&id=<%=rs.getString("id")%>&&name=<%=rs.getString("name")%>&&file=<%=rs.getString("fname")%>' style='color:Green;'>Key Request</a></button></td>
                     </tr><%}%>
                </table>    
        </div>
      </div>
