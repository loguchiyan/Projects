      ...
      <div class="row align-items-center text-center text-md-left">
         ...
         <div class="row">
          <div class="col-lg-3">
            ...
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 208px;">Download File</h1></header><br>
            <div><style>
                    table{
                        line-height: 25px;
                        width: 120%;
                ...
                </table></form><br><!-- data-nav-link holds the ID of nav item, which means this link should behave the same as that nav item  -->
