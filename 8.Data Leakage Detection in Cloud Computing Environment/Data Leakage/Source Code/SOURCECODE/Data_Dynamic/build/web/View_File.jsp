  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-lg-8">
            <header class="mb-4"><h1 class="tm-text-shadow" style="font-family: cursive; margin-left: 84px; margin-top: -30px;"align="center">View File With Encrypted </h1></header><br>
            ...
            String txtFilePath = "C:\\files\\"+image;           
            ...
            String book=sb.toString();
                       ...
                       <center>
                        <h3><%=image%></h3>
                        <form action="Vanother.jsp">
                        <input type="hidden" name="fname" value="<%=image%>">
                        <textarea rows="15" cols="40" style="width:400px;height: 250px; margin-left: 275px; margin-top: -10px;"><%=book%></textarea><br><br>
