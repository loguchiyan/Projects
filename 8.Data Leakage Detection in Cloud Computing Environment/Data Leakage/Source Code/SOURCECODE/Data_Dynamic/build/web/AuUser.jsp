  ...
  <div class="site-wrap">
    ...
    <div class="container pt-5 hero">
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class=""> <header><h1 class="tm-text-shadow" style="font-family: cursive;  font-size: 18px;margin-left: 550px; margin-top: -180px;">View all User & Authorized them</h1></header><br>
            <style>
                    table{
                        line-height: 25px;
                        width: 90%;
