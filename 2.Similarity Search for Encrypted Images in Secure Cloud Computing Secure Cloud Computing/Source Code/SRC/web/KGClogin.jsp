	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight img" style="background-image: url(images/cld1.jpg);">
			...
			<nav id="colorlib-main-menu" role="navigation">
					...
					<li><a href="aalogin.jsp">Attribute Authority</a></li>
      ...
      tr,td{
       ...
       <h2 style="margin-top: 20px; color:maroon; margin-left: 250px;font-family: cambria;font-weight: bold; font-size: 30px;">KGC Login</h2><br>
        <form action="KGC_Login_Action" >
        <table>
         ...
         <h1 style="font-family: cursive; font-size: 23px; color: red;margin-left: 200px; ">New Registration?<a href="Register1.jsp" style="font-family: cursive; font-size: 28x;">Click here</a></h1>
        </div>
