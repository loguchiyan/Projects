...
<html lang="en">
  ...
  <body>
        ...
        <div class="">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
              <a href="User_Login.jsp"><span class="fa fa-sticky-users mr-3"></span>Data User</a>
	          </li>
	          <li>
  ...
  <style>
      ...
      tr,td{
        ...
        <!-- Page Content  -->
        <div class="img" style="background-color: whitesmoke;background-repeat: no-repeat;">
           ...
           <br><br>
        <h2 style="margin-top: 20px; color:darkblue; margin-left: 290px;font-family: cambria;font-weight: bold; font-size: 30px;">Cloud Server Login</h2><br>
        <form action="Cloud" >
        <table>
