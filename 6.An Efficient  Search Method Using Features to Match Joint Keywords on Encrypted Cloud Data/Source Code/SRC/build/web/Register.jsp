  ...
  <style>
     ...
     <% 
         ...
         Connection con=DriverManager.getConnection("jdbc:mysql://localhost/imagecloud","root","root");
           PreparedStatement select=con.prepareStatement("select * from oreg");
        ...
        <div id="content" class="p-4 p-md-5 pt-5" >
         ...
         <br><br>
        <h2 style="margin-top: 20px; color:darkblue; margin-left: 250px;font-family: cambria;font-weight: bold; font-size: 30px;">Data Owner Registration Page</h2><br>
        ...
        <table>
         ...
         <h1 style="font-family: cursive; font-size: 13px; color: red;margin-left: 400px; "><a href="Admin_Login.jsp" style="font-family: cursive; font-size: 28x;">Click here to back</a></h1>
