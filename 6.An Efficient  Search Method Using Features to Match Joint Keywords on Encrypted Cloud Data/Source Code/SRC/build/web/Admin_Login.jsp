...
<html lang="en">
  ...
  <style>
      ...
      tr,td{
        ...
        <!-- Page Content  -->
        <div class="img" style="background-color: white;background-repeat: no-repeat;">
           ...
           <br><br>
        <h2 style="margin-top: 20px; color:darkblue; margin-left: 360px;font-family: cambria;font-weight: bold; font-size: 30px;">Data Owner Login</h2><br>
        <form action="owner_Login_Action" >
        <table>
         ...
         <h1 style="font-family: cursive; font-size: 13px; color: red;margin-left: 400px; ">New Registration?<a href="Register.jsp" style="font-family: cursive; font-size: 28x;">Click here</a></h1>
        <
  </div>
        </div>
