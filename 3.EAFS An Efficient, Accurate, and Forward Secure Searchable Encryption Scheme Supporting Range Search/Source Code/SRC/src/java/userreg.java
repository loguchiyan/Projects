...
public  class userreg extends HttpServlet {
     ...
     */
    String name,pass,email,mobile,city,state;
            ...
            throws ServletException, IOException 
    {
        ...
        PrintWriter out = response.getWriter(); 
        {
            try {
                ...
                PreparedStatement ps22=con.prepareStatement("insert into ureg (name,pass,email,mobile,city,state) values ('"+name+"','"+pass+"','"+email+"','"+mobile+"','"+city+"','"+state+"') ");
                ps22.executeUpdate();
                out.println("<script>"
