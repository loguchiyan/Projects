<%-- 
    Document   : viewusers
    Created on : Aug 2, 2017, 5:02:24 PM
    Author     : DLK 1
--%>
...
<% 
                        ...
                        String Query22="select * from ureg ";
                        ...
                        %>
                                <tr> 
                                    ...
                                    <td  style="color:lightseagreen;font-weight: bold;"><a href="uauth.jsp?id=<%=rs22.getString("id")%>"><%=rs22.getString("status")%></a>&emsp;</td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
