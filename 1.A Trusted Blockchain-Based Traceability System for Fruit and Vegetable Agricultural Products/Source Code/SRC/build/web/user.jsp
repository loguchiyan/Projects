        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1 style="font-size:20px; margin-left:150px; margin-top:-100px;">welcome DataUser Login </h1>
             <style>
                 input{
                     width: 200px;
                     border-radius:12px;
            ...
            <form action="uloginc.jsp" method="post">
                <div class="log">
                <input type="text" placeholder="User Name " name="uuser" />
            </div>
           ...
           <div class="log">
                ...
                <br>
          <div class="log1">
              <button>Submit</button>&ensp;<a href="ureg.jsp" style="color:white;">New User</a>
              </div>  
            </form>
          </div>
            </div>
          ...
          <div class="col-md-5 ">
            <div class="img-box">
              <img src="images/login.jpg" alt=""  style="border-radius: 45%; margin-left:100px; " >
            </div>
          </div>
        </div>
      </div>
