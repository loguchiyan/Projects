    ...
    font-size:13px;
     ...
     <%    
      ...
      String pid=request.getParameter("pid");
                        ...
                        PreparedStatement query=con.prepareStatement("select DISTINCT sno,pid,pname,ouser,uuser,cost,des,status,hashkey from ureq where ouser='"+ouser+"'and status='Accpted'  ");
