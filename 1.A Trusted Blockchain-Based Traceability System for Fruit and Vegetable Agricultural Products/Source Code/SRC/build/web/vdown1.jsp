...
<!--                 <a href="summ.jsp" style=" color: #ffc107;">Purchased Summary</a>&ensp;&ensp;-->
...
h6{
    font-size:13px;
     ...
     <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View  Purchased Products Details</h1>
     ...
     <%    
                        ...
                        PreparedStatement query=con.prepareStatement("select DISTINCT sno,pid,pname,ouser,uuser,cost,des,status,status1,hashkey from ureq   ");
        ...
        <tr>
                    ...
                    <td style=" color: mediumslateblue; font-weight:bold;"><%=status1%></td>
