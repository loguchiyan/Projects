...
<body>
  <div class="hero_area ">
    ...
    <section class="slider_section">
        ...
        <br>
      <div class="container">
          <h1 style=" text-align:center; color:white;font-size:20px; margin-top:-200px;">View user and authorize</h1>
         <br>
         <br>
         <br>
          <table algin="center">
          ...
          PreparedStatement ps1=con.prepareStatement("select * from ureg  ");
             ...
             <tr>
                 <td><%=rs1.getString("sno")%></td>
                    <td><%=rs1.getString("uuser")%></td>
                    <td><%=rs1.getString("email")%></td>
                    <td><a href="uathu1.jsp?sno=<%=rs1.getString("sno")%>" style=" color: darkblue; font-weight:bolder;"><%=rs1.getString("status")%></a></td>
            <%}%></table>
      </div>
    </section>
    <!-- end slider section -->
