        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1 style="font-size:20px; margin-left:110px; margin-top:-140px;">Register Data User(Consumer)!!! </h1>
             <style>
                 input{
                     width: 200px;
                     border-radius:12px;
          ...
          <div class="col-md-5 ">
            <div class="img-box">
              <img src="images/farmer.jpg" alt=""  style="border-radius: 50%; margin-left:100px; " >
            </div>
          </div>
        </div>
      </div>
