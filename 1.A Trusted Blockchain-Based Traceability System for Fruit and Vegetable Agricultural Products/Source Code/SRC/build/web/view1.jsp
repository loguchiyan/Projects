        ...
        <div class="row">
          <div class="col-md-6 ">
            ...
            <div class="img-box">
                ...
                <a href="veg.jsp" style="color:white; font-size:30px; margin-left: 120px;;">Vegetables Block</a>
             <a href="veg.jsp"> <img src="images/veg.jpg" alt="" style=" border-radius:50%;height:300px; width:500px; " /></a>
            </div>
            </div>
          </div>
          <div class="col-md-6 ">
            <div class="img-box"> 
                <a href="frut.jsp" style="color:white; font-size:30px; margin-left: 160px;;">Fruits Block</a>
             <a href="frut.jsp"> <img src="images/frut.jpg" alt="" style=" border-radius:50% ;width:500px; height:300px;" />
            </div>
          </div>
