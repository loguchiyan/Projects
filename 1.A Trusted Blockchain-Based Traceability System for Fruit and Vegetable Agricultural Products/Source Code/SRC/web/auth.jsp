...
<body>
  <div class="hero_area ">
    ...
    <section class="slider_section">
        ...
        <br>
      <div class="container">
          <h1 style=" font-size: 20px; margin-top:-100px; color:white; text-align: center;"><a style=" color: white" href="uathu.jsp">User block and Authorize</a>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<a  style=" color: white" href="oauth.jsp">Owner block and Authorize</a></h1>  
          <br>
          <br>
          <img src="images/authr.jpg" alt="" style="width:300px; height:300px; margin-left:400px;" />
