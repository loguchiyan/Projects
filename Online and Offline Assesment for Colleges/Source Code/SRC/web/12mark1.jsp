...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="hero-content-wrap flex flex-column justify-content-center align-items-start">
                         ...
                         <br>
                           <br>
                         <h4  style=" font-size: 20px; margin-top: -200px; color:#18d26e;font-weight: bolder; margin-left:320px;">Select Student name</h4>
                           <br>
                           <br>
  ...
  <form action="12ans.jsp">
                    <table align="center">
                        <tr><td><strong>Search By  Student: </strong></td><td>
                            <select name="user" style="border-radius: 10px;  height: 20px; width: 250px; height: 30px" required>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from answer12 group by user");
                        ResultSet rs=query.executeQuery();
	            	while(rs.next())
	            	{
                        %>
                       
                                <option  ><%=rs.getString("user")%></option><%}%>
