...
<body>
                    ...
                    <div class="col-12">
                        <div class="hero-content-wrap flex flex-column justify-content-center align-items-start">
                            <header class="entry-header">
                                ...
                                %>
                                  <h4  style=" font-size: 20px; margin-top: -200px; color:#18d26e;font-weight: bolder; margin-left:300px;">View Overall Mark!!!</h4>
                           <br>
                           <br>
   ...
   <table align="center" border="1" style="width: 90% !important; margin-left: 180px;line-height: 1.7;background: aliceblue;border-radius: 12px;text-align: left;color: black;text-transform: capitalize;">
	            ...
	            <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from results  where user='"+user+"' ");
	             ...
	             %>
	            			<tr>
	            				...
	            				<td style=" color: black;"><%=rs.getString("total") %></td>
                                                 <td style=" color: green;"><%=rs.getString("mark") %></td>
