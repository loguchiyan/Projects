                           ...
                           <style>
                               ...
                               <form action="mcqaction2.jsp">
                                <table align="center" style="width: 400px;line-height: 3;">
                                    ...
                                    <tr style="color:  white;font-weight: bold;"><td>Question 3</td><td><input type="textarea" name="q3" style="color: navy;" required></td></tr>
                                    
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">4)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 4</td><td><input type="textarea" name="q4" style="color: navy;" required></td></tr>
                                   
                                    <tr style="color:#18d26e;font-weight: bold;"><td colspan="2">5)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 5</td><td><input type="textarea" name="q5" style="color: navy;" required></td></tr>
                                    
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">6)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 6</td><td><input type="textarea" name="q6" style="color: navy;" required></td></tr>
                                    
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">7)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 7</td><td><input type="textarea" name="q7" style="color: navy;" required></td></tr>
                                   
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">8)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 8</td><td><input type="textarea" name="q8" style="color: navy;" required></td></tr>
                                    
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">9)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 9</td><td><input type="textarea" name="q9" style="color: navy;" required></td></tr>
                                   
                                    <tr style="color: #18d26e;font-weight: bold;"><td colspan="2">10)--------------------------------------------------</td></tr>
                                    <tr style="color:  white;font-weight: bold;"><td>Question 10</td><td><input type="textarea" name="q10" style="color: navy;" required></td></tr>
