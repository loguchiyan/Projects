  ...
  <section id="container">
    ...
    <section id="main-content" style=" background-color: #2f323a;">
     ...
     <main >
                   ...
                   <h1 style=" color: whitesmoke; font-size:30px; font-family:  monospace; align:centre; font-weight:Bolder; margin-left: 550px; margin-top: 10px; ">Prediction in Graph.... <h1>
                ...
                <br>
                <br>
                <a  href="Graph1.jsp"><h4 >Prediction based on groups </h4></a> 
                <a href="Graph2.jsp"><h4>Prediction based on More Post in Group</h4></a>
                <a href="Graph3.jsp"><h4>Prediction based on Behaviour</h4></a></div>
