  ...
  <section id="container">
    ...
    <section id="main-content" style=" background-color: #2f323a;">
      ...
      String topic=request.getParameter("topic");
                        ...
                        PreparedStatement query=con.prepareStatement("select topic,Count(*)Total_Vote from recommed where topic='"+topic+"' group by status ORDER BY Total_vote DESC " );
