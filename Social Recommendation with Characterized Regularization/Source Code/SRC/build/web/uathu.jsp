          ...
          <div class="row " style="margin-top: 200px;">
               ...
               <style>
                      ...
                      th{
                        ...
                        <h3 class="h4" align="center" style=" color: white; font-size: 20px; margin-bottom: 400px; margin-top: -180px; margin-left:-100px; "> View all users and Authorize ... </h3>
                     ...
                     <%                    
                      ...
                      %>
                            ...
                            <td><img src="profile/<%=rs.getString("profile")%>" alt="image" style="width:40px; height:40px;"></td>
