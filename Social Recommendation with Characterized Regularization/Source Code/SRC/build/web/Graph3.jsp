...
PreparedStatement p=con.prepareStatement("select count(status)as cou,status from post group by status ");
ResultSet r=p.executeQuery();
List<Map<Object,Object>> list = new ArrayList<Map<Object,Object>>();
while(r.next()){
    String filename=r.getString("status");
