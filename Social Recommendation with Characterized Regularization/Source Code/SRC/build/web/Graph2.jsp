...
PreparedStatement p=con.prepareStatement("Select count(grup) as cou,grup from post group by grup ");
ResultSet r=p.executeQuery();
List<Map<Object,Object>> list = new ArrayList<Map<Object,Object>>();
while(r.next()){
    String filename=r.getString("grup");
...
var chart = new CanvasJS.Chart("chartContainer", {
	theme: "light3",
	title: {
		text: "Based on the Site in User Post"
	},
	axisX: {
		title: "site"
	},
