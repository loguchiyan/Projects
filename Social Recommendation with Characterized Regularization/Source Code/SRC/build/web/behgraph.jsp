...
PreparedStatement paa= con.prepareStatement("SELECT status,COUNT(status)as postive FROM recommed where topic='"+topic+"' GROUP BY status ");
ResultSet r=paa.executeQuery();
while(r.next()){
    String status=r.getString("status");
    int tot=r.getInt("postive");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	exportEnabled: true,
	title:{
            text: "Classification Results based on <%=topic%>"
	},
	data: [{
		type: "pie",
		showInLegend: true,
