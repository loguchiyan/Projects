    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
        ...
        <div class="header-text">
            <br>
            <br>
             <h1 style="color: white;font-size:19px; font-weight:bold;  margin-left:360px; margin-top:100px; "><strong> View Recommended Posts</strong></h1>
                        ...
                        while(rs.next()){
                         ...
                         <table>
                            ...
                            <tr><th>Description</th><td><%=rs.getString("description")%></td></tr>
                              <tr><th>Description</th><td><%=rs.getString("review")%></td></tr>
