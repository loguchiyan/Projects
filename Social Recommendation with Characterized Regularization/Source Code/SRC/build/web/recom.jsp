...
<%
  ...
  String review=request.getParameter("review");
   ...
   PreparedStatement ps=con.prepareStatement("Insert into recommed (image,description,topic,grup,location,review,user)values ('"+profile+"','"+description+"','"+topic+"','"+grup+"','"+location+"','"+review+"','"+name+"')");
