      ...
      <section class="wrapper">
        <div class="row">
             ...
             <main >
              ...
              <h3 class="h4" align="center" style=" color: white; font-size: 19px; margin-bottom: 600px;  margin-top: 100px; margin-left: -80px;"> Negative Vibes based on Posts</h3>
            ...
            for(int i=0;i<word.length;i++)
                ...
                if(rs1.next())
                {
                           ...
                           <td> <%=rs.getString("grup")%></td>
                            ...
                            <%
                  PreparedStatement query4=con.prepareStatement("update recommed set status='Negative' where user='"+rs.getString("user")+"'");
