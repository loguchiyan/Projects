      ...
      <section class="wrapper">
        <div class="row">
             ...
             <main >
                ...
                <h1 style="color: white;font-size:19px; font-weight:bold;  margin-left:360px; margin-top:200px; "><strong> View  post and Recommended to Groups</strong></h1>
                ...
                <style>
                   ...
                   <table style="margin-top:100px; width: 70%; margin-left:150px;">
                       <tr>
                           <th>User Name</th>
                           <th>Topic</th>
                           <th>Image</th>
...
<!--                           <td><button><a href="recomd.jsp?sno=<%=r.getString("sno")%>">Recommend</a></button></td>
                    -->
                        <td><button><a href="review.jsp?sno=<%=r.getString("sno")%>">Review</a></button></td>
