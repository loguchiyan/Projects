    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="margin-top: 200px;">
            ...
            <h3 class="h4" align="center" style=" color: white; font-size: 18px; margin-bottom: 400px; margin-top: -180px; margin-left:-100px; ">
View Behaviour Prediction based on Post </h3>
	<table>					
            <tr>                                               
            <th>Group</th>
           <th>Details</th>
                     ...
                     <%                    
                        ...
                        PreparedStatement query=con.prepareStatement("Select distinct topic from recommed " );
                        ...
                        while(rs.next()){
                         ...
                         %>
                          ...
                          <tr>
                           ...
                           <td><a style="background-color: skyblue; color:  black;" href="behgraph.jsp?topic=<%=rs.getString("topic")%>">View Details</a></td>
                      <%}%>
            </tr></table>
